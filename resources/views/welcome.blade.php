                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 btn btn-success">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg w-100">
                    <div class="jumbotron jumbotron-fluid">
                        <div class="container">
                            <h1 class="display-4">Practica 8</h1>
                            <p class="lead">Estudiante: Univ. Hector daniel Quispe Huanca</p>
                            <p class="lead">Materia: Emergentes de la Web</p>
                        </div>
                    </div>
                </div>
            </div>
